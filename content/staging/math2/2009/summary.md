# Math2 2009 Aggregate Staging Summary

- Source title: `考研数学试卷二解答`.
- Status: staging only; all records remain `needs_human_review` and `blocked`.
- Questions generated: 23.
- Counts: {"fill_in_blank": 6, "multiple_choice": 4, "proof": 0, "solution": 9, "unknown": 4}.
- Answers sourced into answer field: 10.
- Explanations sourced: 17.
- Schema valid: true.
