# Math2 2012 Aggregate Staging Summary

- Source title: `考研数学试卷二解答`.
- Status: staging only; all records remain `needs_human_review` and `blocked`.
- Questions generated: 16.
- Counts: {"fill_in_blank": 6, "multiple_choice": 0, "proof": 0, "solution": 9, "unknown": 1}.
- Answers sourced into answer field: 6.
- Explanations sourced: 11.
- Schema valid: true.
