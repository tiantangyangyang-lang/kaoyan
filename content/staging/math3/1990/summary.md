# Math3 1990 Aggregate Staging Summary

- Source title: `考研数学试卷三解答`.
- Status: staging only; all records remain `needs_human_review` and `blocked`.
- Questions generated: 20.
- Counts: {"fill_in_blank": 5, "multiple_choice": 3, "proof": 0, "solution": 10, "unknown": 2}.
- Answers sourced into answer field: 7.
- Explanations sourced: 14.
- Schema valid: true.
