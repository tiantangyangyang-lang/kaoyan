# Math3 1992 Aggregate Staging Summary

- Source title: `考研数学试卷三解答`.
- Status: staging only; all records remain `needs_human_review` and `blocked`.
- Questions generated: 16.
- Counts: {"fill_in_blank": 1, "multiple_choice": 4, "proof": 0, "solution": 10, "unknown": 1}.
- Answers sourced into answer field: 5.
- Explanations sourced: 13.
- Schema valid: true.
