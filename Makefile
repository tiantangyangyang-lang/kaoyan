...
.PHONY: content-override-dry-run content-override-commit content-override-example-dry-run animation-samples-replace-dry-run animation-samples-replace-commit probability-animation-replace-dry-run probability-animation-replace-commit
...
help:
	...
	@echo "  make content-db-approve-dry-run  Validate the fixed approval scope and roll back"
	@echo "  make content-db-approve-commit   Approve the fixed scope with known risks"
	@echo "  make content-db-publish-dry-run  Validate promotion of the fixed 74 batches"
	@echo "  make content-db-publish-commit   Publish the fixed 74 batches"
	@echo "  make content-db-unpublish-dry-run  Validate rollback of the fixed 74 batches"
	...
	@echo "  make math1-2025-q04-explanation-correct-dry-run  Validate Q04 explanation correction and roll back"
	...
	@echo "  make animation-samples-replace-dry-run        Validate three Motion replacements and roll back"
	@echo "  make animation-samples-replace-commit         Replace the fixed three Motion samples"
	@echo "  make probability-animation-replace-dry-run    Validate q22 animation replacement and roll back"
	@echo "  make probability-animation-replace-commit     Replace only math1-2023-q22 animation"
...
content-db-approve-dry-run:
	$(NPM) run content:approve --workspace @kaoyan/api

content-db-approve-commit:
	$(NPM) run content:approve --workspace @kaoyan/api -- --commit

content-db-publish-dry-run:
	$(NPM) run content:publish-authorized --workspace @kaoyan/api

content-db-publish-commit:
	$(NPM) run content:publish-authorized --workspace @kaoyan/api -- --commit

content-db-unpublish-dry-run:
	$(NPM) run content:unpublish-authorized --workspace @kaoyan/api

content-db-unpublish-commit:
	$(NPM) run content:unpublish-authorized --workspace @kaoyan/api -- --commit
...
math1-2025-q04-explanation-correct-dry-run:
	$(NPM) run content:correct-math1-2025-q04-explanation --workspace @kaoyan/api

math1-2025-q04-explanation-correct-commit:
	$(NPM) run content:correct-math1-2025-q04-explanation --workspace @kaoyan/api -- --commit

math1-2025-q04-explanation-content-verify:
	node scripts/verify_math1_2025_q04_explanation_content.mjs
...
animation-samples-replace-dry-run:
	$(NPM) run content:replace-animation-samples --workspace @kaoyan/api

animation-samples-replace-commit:
	$(NPM) run content:replace-animation-samples --workspace @kaoyan/api -- --commit

probability-animation-replace-dry-run:
	$(NPM) run content:replace-probability-animation --workspace @kaoyan/api

probability-animation-replace-commit:
	$(NPM) run content:replace-probability-animation --workspace @kaoyan/api -- --commit
