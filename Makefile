...
help:
	...
	@echo "  make math2-1987-2019-audit    Audit Math2 1987-2019 aggregate split readiness"
...
math2-1987-2019-audit:
	$(PYTHON) scripts/audit_math2_1987_2019.py "$(MATH2_SOURCE)" "$(MATH2_1987_2019_REPORT)"
	set MATH2_SOURCE_DIR=$(MATH2_SOURCE)&& $(PYTHON) -m unittest tests.test_audit_math2_1987_2019 -v
...
verify: math2-validate math2-2021-2022-audit math2-1987-2019-audit math2-2023-validate math2-2024-validate typecheck test build
