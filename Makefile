...
help:
	...
	@echo "  make math2-2022-validate      Validate Math2 2022 source-role blocker"
...
math2-2022-source-role:
	$(PYTHON) scripts/audit_math2_2022_source_role.py "$(MATH2_SOURCE)" "$(MATH2_2022_REPORT)"

math2-2022-validate: math2-2022-source-role
	set MATH2_SOURCE_DIR=$(MATH2_SOURCE)&& $(PYTHON) -m unittest tests.test_audit_math2_2022_source_role -v
...
verify: math2-validate math2-2021-2022-audit math2-2022-validate math2-2023-validate math2-2024-validate typecheck test build
