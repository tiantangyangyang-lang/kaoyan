...
.PHONY: help install sync dev dev-api typecheck typecheck-web typecheck-api test test-api test-smoke build build-web build-api math2-inventory math2-pilot math2-katex math2-validate math2-import-dry-run test-math2 test-python-all verify
...
verify: math2-validate typecheck test build
