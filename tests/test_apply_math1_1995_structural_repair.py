...
from scripts.apply_math1_1995_structural_repair import (
...
STAGING = ROOT / "content" / "staging" / "math1" / "1995" / "questions.json"


class TestMath11995StructuralRepair(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
