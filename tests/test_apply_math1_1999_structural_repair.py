...
from scripts.apply_math1_1999_structural_repair import (
...
STAGING = ROOT / "content" / "staging" / "math1" / "1999" / "questions.json"


class TestMath11999StructuralRepair(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_q10_a_option_is_restored(self):
        ...
        self.assertEqual(q10["options"][0]["value"], r"P\{X + Y\leqslant 0\} = \frac{1}{2}.")
