"""Repair deterministic Math1 1998 option-extraction issues."""
...
def validate(result):
    ...
    if result["validation"]["questionsWithExplanations"] != 23:
        errors.append("all 23 questions must retain explanations")
...
def main():
    ...
    print(
        f"Math1 1998 structural repair: {len(result['questions'])} questions, "
