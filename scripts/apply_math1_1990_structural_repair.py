"""Repair deterministic Math1 1990 solution-boundary issues."""
...
def apply_structural_repairs(staging):
    ...
    container = question_by_number(questions, 6)["explanationCandidate"]
    parts = split_repeated_local_parts(container, [1, 2, 3, 4, 5, 1, 2, 3])
...
def main():
    ...
    print(
        f"Math1 1990 structural repair: {len(result['questions'])} questions, "
